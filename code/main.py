import modeBTree as j
import time
inicio = time.time()
#Area para probar funciones
print("------------------Pruebas para Bases de datos-----------------------")
print("CREAR BD:", j.createDatabase("CALIFICAION"), "Esperado:",0)
print("CREAR BD:", j.createDatabase("CALIFICAION"), "Esperado:",2)
...
print("CREAR BD:", j.createDatabase("calificacion"), "Esperado:",0)
