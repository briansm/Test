...
print("CREAR BD:", j.createDatabase("CALIFICAION",'hash','ascii'), "Esperado:",0)
print("CREAR BD:", j.createDatabase("CALIFICAION",'hash','ascii'), "Esperado:",2)
...
print("CREAR BD:", j.createDatabase("calificacion",'hash','ascii'), "Esperado:",0)
